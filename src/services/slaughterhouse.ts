...
export const createSlaughterhouse = async (
  slaughterhouse: Omit<Slaughterhouse, 'id'>,
...
export const editSlaughterhouse = async (
...
export const deleteSlaughterhouse = async (slaughterhouseId: string): Promise<void> => {
  return apiClient
...
export const getSlaughterhouseUnits = async (
  slaughterhouseId: string,
): Promise<SlaughterhouseUnit[]> => {
  return apiClient
...
export const getSlaughterhouseUnit = async (
  slaughterhouseId: string,
...
export const createSlaughterhouseUnit = async (
  slaughterhouseId: string,
  slaughterhouseUnit: Omit<SlaughterhouseUnit, 'id'>,
): Promise<SlaughterhouseUnit> => {
  return apiClient
...
export const editSlaughterhouseUnit = async (
  slaughterhouseId: string,
  slaughterhouseUnit: SlaughterhouseUnit,
): Promise<SlaughterhouseUnit> => {
  return apiClient
    .put<SlaughterhouseUnit>(
      `/slaughterhouses/${slaughterhouseId}/units/${slaughterhouseUnit.id}`,
      slaughterhouseUnit,
    )
    .then((response) => response.data)
    .catch((err) => {
...
export const deleteSlaughterhouseUnit = async (
  slaughterhouseId: string,
  slaughterhouseUnitId: string,
): Promise<void> => {
  return apiClient
