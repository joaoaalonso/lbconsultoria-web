...
const ReportWeights: React.FC<ReportWeightsProps> = ({ report }) => {
  ...
  return (
    <div className="section">
      <div className="section-title">PESOS</div>

      <div className="section-content">
        <div className="column">
          <p>
            VALOR DA @ NEGOCIADA: <b>{value ? formatCurrency(value) : '-'}</b>
          </p>
          <p>
            PESO TOTAL: <b>{formatNumber(totalWeight)}KG</b>
          </p>
          <p>
            PESO TOTAL@: <b>{formatNumber(totalWeight / ARROBA)}</b>
          </p>
          <p>
            PESO VIVO: <b>{formatNumber(PV)}KG</b>
          </p>
        </div>

        <div className="column">
          <p>
            MÉDIA DO LOTE@: <b>{formatNumber(avg)}</b>
          </p>
          <p>
            PESO DE CARCAÇA: <b>{formatNumber(PC)}KG</b>
          </p>
          <p>
            RENDIMENTO DE CARCAÇA: <b>{Number.isFinite(RC) ? formatPercentage(RC) : '-'}</b>
          </p>
        </div>
      </div>
    </div>
