    ...
    >
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            <div className="column">
              <DatePicker label="Data" name="date" control={control} errors={errors} required />
            </div>
            <div className="column">
              <Select
                label="Unidade"
          ...
          <div className="row">
            <div className="column">
              <TextField
                label="Avaliação do curral"
                name="corralEvaluation"
                type="textarea"
                register={register}
                errors={errors}
                required
